...
public class GalleryMultipleActivity extends BaseMultipleActivity implements ImageDataSource.OnImagesLoadedListener,ImageGridAdapter.OnImageItemClickListener,
        View.OnClickListener,OnImageSelectedListener {
   ...
   // private List<ImageFolder> mImageFolders;   //所有的图片文件夹
    ...
    private void initView(){
        ...
        mImageGridAdapter = new ImageGridAdapter(this, null,mSelectedImages,pImagePickerConfig);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            if (checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ImageDataSource imageDataSource = new ImageDataSource(this, null, this);
            } else {
    ...
    protected void onDestroy() {
        super.onDestroy();
        //清空内存
        //ImageLoaderInterface.getInstance().clearMemoryCache();
        //停止线程池
        PImageLoader.stop();
    }
    ...
    public void onImagesLoaded(List<ImageFolder> imageFolders) {
        ...
        mImageGridAdapter.setOnImageSelectedListener(this);
    ...
    private void updateUI(){
        ...
        if (selectCount > 0) {
            ...
            if(pImagePickerConfig.getMaxFiles() == -1){
                mBtnOk.setText(getString(R.string.select_complete_nomax,selectCount));
            }
            else{
